<!--- banner --->
<img src="./github-header-banner.png" alt="Hello world">
...
- 🌱 Currently exploring **React with TypeScript**
- 🔭 Working on building real-world projects to strengthen my skills
- 📚 Recently completed **JavaScript** and **TypeScript** fundamentals
- ⚡ Fun fact: I went from zero to building full UIs with Tailwind CSS!
...
- 📖 Learning **Next.js** — the full stack React framework
- 💡 Exploring **Firebase** for authentication and database
- 🎯 Improving my problem-solving skills with JavaScript challenges
